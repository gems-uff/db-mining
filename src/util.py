...
ANNOTATED_FILE_JAVA = RESOURCE_DIR + os.sep + 'annotated_java_test.xlsx' #'annotated_java_vulnerabilities.xlsx' #'annotated_java.xlsx'
ANNOTATED_FILE_JAVA_COMPLET = RESOURCE_DIR + os.sep + 'filtered_projects_2024 - 07_09_24.xlsx' # 
...
FILTERED_PAPERS_FILE_2024 = RESOURCE_DIR + os.sep + 'filtered_papers_2024.xlsx'
FILTERED_PAPERS_FILE_2026 = RESOURCE_DIR + os.sep + 'filtered_papers_2026.xlsx'
FILTERED_PAPERS_FILE_VUL_2026 = RESOURCE_DIR + os.sep + 'filtered_papers_vulnerabilidades_2026.xlsx' 
...
HISTORICAL_RULES_V1 = RESOURCE_DIR + os.sep + 'historical_rulesv1.xlsx'
