...
from util import ANNOTATED_FILE_JAVA_SAMPLE, HEURISTICS_DIR, REPOS_DIR, red, green, yellow, CODE_DEBUG
...
def main():
    ...
    print(f'Loading projects from {ANNOTATED_FILE_JAVA_SAMPLE}.')
